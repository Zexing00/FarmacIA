...
public class DatabaseHelper extends SQLiteOpenHelper {
    ...
    private static final int DATABASE_VERSION = 2; // Incrementamos versión
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        db.execSQL("INSERT INTO " + TABLE_MEDICAMENTOS + " (" + COLUMN_MED_NOMBRE + ", " + COLUMN_MED_PROSPECTO + ") VALUES ('Loratadina', 'Antihistamínico. Una vez al día.');");

        // Asignar medicamentos al usuario 'user' (ID 2 supuestamente)
        // Ibuprofeno y Amoxicilina para 'user'
        db.execSQL("INSERT INTO " + TABLE_PASTILLERO + " (" + COLUMN_PAST_USER_ID + ", " + COLUMN_PAST_MED_ID + ") VALUES (2, 1);");
